...
AppId={{0838DC7C-A520-4C90-A717-FAD54427FE7B}
AppName={#MyAppName}
...
[Files]
Source: "{#ProjectRoot}\dist\TraductorApp\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#ProjectRoot}\dist\TraductorApp\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
